      ...
      <v-row>
        <v-col>
          <v-card>
            ...
            <v-card-text>
              <v-sheet outlined rounded class="d-flex justify-space-around align-center">
                <v-img
                ...
                <div v-if="!access.isAgreement && !access.isBudget">
                  ...
                  <p class="subtitle-1">
                    Não há nenhum orçamento realizado em sua conta. Faça um orçamento:
                  </p>
                </div>
                <div v-if="access.isAgreement">
                  ...
                  >
                    ...
                    <div v-if="engaged" v-show="engaged.selectEngaged">
                      ...
                      <p>
                        <span style="font-size: 14px"
                          >RG: {{ engaged.bride_rg }}&nbsp;&nbsp; &nbsp; &nbsp;CPF:
                          {{ engaged.bride_cpf }}&nbsp; &nbsp; &nbsp; Data Nascimento:
                          {{
                            $moment(engaged.bride_birthdate).format("DD/MM/YYYY")
                          }}</span
                        >
                      </p>
                      ...
                      <p>
                        <span style="font-size: 14px"
                          ...
                          {{ engaged.groom_cpf }}&nbsp; &nbsp; &nbsp; Data Nascimento:
                          {{
                            $moment(engaged.groom_birthdate).format("DD/MM/YYYY")
                          }}</span
                        >
                      </p>
                    ...
                    <p style="text-align: justify">
                      <span style="font-size: 14px"
                        ...
                        presta&ccedil;&atilde;o e execu&ccedil;&atilde;o de
                        servi&ccedil;os musicais, conforme as clausulas que seguem
                        abaixo:</span
                      >
                    </p>
                    ...
                    <p style="text-align: justify">
                      <span style="font-size: 14px"
                        ...
                        }}&nbsp;({{ contract.value_total_extenso }}) a serem pagos da
                        seguinte forma:
                      </span>
                    </p>
                    ...
                    <p style="text-align: justify">
                      <span style="font-size: 14px"
                        ...
                        {{ contract.down_payment.replace(".", ",") }}&nbsp;({{
                          ...
                          $moment(contract.down_payment_date).format("DD/MM/YYYY")
                        }}&nbsp;e o restante, podendo efetuar o pagamento em at&eacute; 15
                        (quinze) dias &uacute;teis antes do evento (clausula 2&ordf;), sob
                        pena de cancelamento do contrato motivado pelo contratante
                        conforme par&aacute;grafo 4&ordm;.</span
                      >
                    </p>
                    ...
                    <p style="text-align: justify">
                      <span style="font-size: 14px"
                        ...
                        contrato, os d&eacute;bitos arcados pelo CONTRATANTE
                        sofrer&atilde;o multa de 2% (dois por cento) e juros de 1% (um por
                        cento) ao dia.</span
                      >
                    </p>
                    ...
                    <p style="text-align: justify">
                      <span style="font-size: 14px"
                        ...
                        contrato, por qualquer motivo, sendo a parte CONTRATANTE
                        motivadora da dissolu&ccedil;&atilde;o, o mesmo n&atilde;o
                        ter&aacute; direito &agrave; devolu&ccedil;&atilde;o do valor
                        pago. Caso ainda o CONTRATANTE n&atilde;o tenha pagado nenhum
                        valor contratado e se for dele o motivo da
                        dissolu&ccedil;&atilde;o do contrato, o mesmo pagar&aacute; a
                        titulo de multa por quebra de contrato de 30% (trinta por cento)
                        do valor contido na clausula 1&ordf; e desde que, avisado com pelo
                        menos 60 dias de anteced&ecirc;ncia.
                      </span>
                    </p>
                    ...
                    <p style="text-align: justify">
                      <span style="font-size: 14px"
                        ...
                        deste contrato at&eacute; o prazo estabelecido na clausula
                        1&ordf;, par&aacute;grafo 1&ordm; deste documento desobriga
                        automaticamente a CONTRATADA da execu&ccedil;&atilde;o dos
                        servi&ccedil;os aqui descritos ao CONTRATANTE, salvo se, este,
                        quitar o valor restante exclusivamente em esp&eacute;cie e/ou
                        concordar com a condi&ccedil;&atilde;o de uma cau&ccedil;&atilde;o
                        da pra&ccedil;a no valor total deste documento e que ser&aacute;
                        devolvido ap&oacute;s quita&ccedil;&atilde;o do saldo devedor
                        acrescido de multa e juros conforme par&aacute;grafo 3&ordm;
                        acima. O descumprimento do prazo pelo CONTRATANTE e a n&atilde;o
                        execu&ccedil;&atilde;o do trabalho por esse motivo ou qualquer
                        outro motivado por este, n&atilde;o diminui nem exclui o
                        CONTRATANTE da quita&ccedil;&atilde;o deste documento em seu valor
                        total dentro dos prazos estabelecidos.</span
                      >
                    </p>
                    ...
                    <p style="text-align: justify">
                      <span style="font-size: 14px"
                        ...
                        obriga&ccedil;&atilde;o do CONTRATANTE contida na clausula
                        1&ordf;, a prestar servi&ccedil;os de execu&ccedil;&atilde;o de
                    ...
                    <p style="text-align: justify">
                      <span style="font-size: 14px"
                        ...
                        responsabilidade da CONTRATADA levar seus instrumentos musicais e
                        equipamentos de som para o evento contratado (caso a igreja,
                        institui&ccedil;&atilde;o ou local do referido evento n&atilde;o
                        possuam) inerentes &agrave; boa execu&ccedil;&atilde;o do
                        trabalho. Os equipamentos e instrumentos da CONTRATADA s&atilde;o
                        espec&iacute;ficos para a execu&ccedil;&atilde;o do trabalho
                        desta, n&atilde;o sendo dela a obriga&ccedil;&atilde;o de
                        sonorizar qualquer outro tipo de ambiente ou
                        situa&ccedil;&atilde;o e ainda, terceiros.</span
                      >
                    </p>
                    ...
                    <p style="text-align: justify">
                      <span style="font-size: 14px"
                        ...
                        escolher o repert&oacute;rio de musicas para seu casamento de
                        acordo com cada momento da cerim&ocirc;nia, sem limite de
                        m&uacute;sicas.</span
                      >
                    </p>
                    ...
                    <p>
                      <span style="font-size: 14px"
                        ...
                        auxiliar e orientar as escolhas de musicas para a cerim&ocirc;nia
                        do CONTRATANTE, sem, por&eacute;m, influenciar na decis&atilde;o
                        final. At&eacute; uma musica que n&atilde;o tenha no
                        repert&oacute;rio da CONTRATADA &eacute; inclu&iacute;da sem custo
                        adicional.</span
                      >
                    </p>
                    ...
                    <p style="text-align: justify">
                      <span style="font-size: 14px"
                        ...
                        n&atilde;o podendo mais faz&ecirc;-lo ap&oacute;s esse prazo,
                        salvo se a CONTRATADA julgar poss&iacute;vel.</span
                      >
                    </p>
                    ...
                    <p style="text-align: justify">
                      <span style="font-size: 14px"
                        ...
                        assinatura deste contrato, estar no local, data e horário
                        estabelecido na Clausula 2&ordf;, para a realização do
                        trabalho.</span
                      >
                    </p>
                    ...
                    <p style="text-align: justify">
                      <span style="font-size: 14px"
                        ...
                        CONTRATADA na eventualidade de ocorrer falta de energia elétrica
                        no evento, falta de segurança para a equipe CONTRATADA ou até
                        casos extremos (acidentes graves ou até morte de membros da
                        equipe), não cabendo a parte CONTRATANTE pedido de
                        indenização.</span
                      >
                    </p>
                    ...
                    <p style="text-align: justify">
                      <span style="font-size: 14px"
                        ...
                        chuvas, temporais ou qualquer outra espécie de adversidade
                        climática que possa danificar instrumentos e equipamentos,
                        prejudicar a saúde dos integrantes da equipe, sendo o local
                        ambiente aberto ou exposto, a CONTRATADA se reserva o direito de
                        desligar e desmontar imediatamente todo o equipamento e/ou não
                        montar e nem ligar, caso ainda não tenha sido feito, cancelando o
                        trabalho se o CONTRATANTE não providenciar local seguro para a
                        execução do trabalho, não dando direito ao CONTRATANTE pedido de
                        indenização ou qualquer estorno de valor pago.</span
                      >
                    </p>
                    ...
                    <p style="text-align: justify">
                      <span style="font-size: 14px"
                        ...
                        Qualquer tempo a mais que a CONTRATADA permanecer no evento devido
                        a atrasos, será cobrado um adicional com mesmo valor deste
                        documento contido na cláusula 1&ordf;, cabendo à CONTRATADA e não
                        ao CONTRATANTE a decisão de permanecer ou não no evento após o
                        tempo determinado.</span
                      >
                    </p>

                    <p>
                      <span style="font-size: 14px"
                        >Parágrafo 4&ordm; - Na casualidade de ocorrer atraso para o
                        inicio da cerimônia, serão tolerados pela CONTRATADA atrasos de no
                        máximo 20 (vinte minutos) após o horário acima declarado, não
                        havendo responsabilidade por parte da CONTRATADA em continuar no
                        local após esse período.</span
                      >
                    </p>
                    ...
                    <p style="text-align: justify">
                      <span style="font-size: 14px"
                        ...
                        equipamentos/instrumentos de som da CONTRATADA ocasionados pelo
                        CONTRATANTE, seus convidados ou ainda, terceiros contratados pelo
                        CONTRATANTE para o evento, serão de inteira responsabilidade do
                        CONTRATANTE, sob pena de pagamentos em Dobro dos Danos
                        ocasionados, caso a CONTRATADA tenha que ingressar com Ação
                        Judicial.</span
                      >
                    </p>
                    ...
                    <p style="text-align: justify">
                      <span style="font-size: 14px"
                        >Clausula 7&ordf; - O serviço de assistente que a CONTRATADA
                        oferece é exclusivo para auxilio da equipe de músicos, não se
                        obrigando a responsabilizar por demais encargos.</span
                      >
                    </p>
                    ...
                    <p>
                      <span style="font-size: 14px"
                        ...
                        soluções de quaisquer questões decorrentes deste termo, com
                        expressa renúncia a qualquer outro, por mais privilegiado que
                        seja.</span
                      >
                    </p>
                    ...
                    <p>
                      <span style="font-size: 14px"
                        >E por estarem de acordo com as condições estabelecidas, as
                        partes, CONTRATANTE e CONTRATADA assinam este instrumento em 02
                        (duas) vias de igual teor e eficácia.</span
                      >
                    </p>
                    <hr />
                    <v-row>
              ...
              <v-sheet v-if="!access.isAgreement" class="mt-3">
                ...
                <v-btn
                  ...
                  ><v-icon class="mr-3">mdi-text-box-plus</v-icon>Gerar contrato</v-btn
                >
              </v-sheet>
            </v-card-text>
