                ...
                <v-card width="400" height="300" color="blue darken-4">
                    ...
                    <v-card-text>
                        <v-form ref="formLogin">
                            ...
                            <v-text-field v-model="loginPassword" label="Senha" dark :rules="loginPasswordRules"
                ...
                <v-row>
                    ...
                    <v-col cols="12" md="6" lg="3">
                        <v-card>
                            ...
                            <v-card-actions>
                                <v-spacer></v-spacer>
                                <v-btn depressed large color="amber darken-3" class="white--text"
                                    @click="showActive('repertory')">
                                    Gerenciar
                                </v-btn>
                            </v-card-actions>
                        </v-card>
                    ...
                    <v-col cols="12" md="6" lg="3">
                        <v-card>
                            ...
                            <v-card-actions>
                                <v-spacer></v-spacer>
                                <v-btn depressed large color="red darken-3" class="white--text"
                                    @click="showActive('agreement')">
                                    Gerenciar
                                </v-btn>
                            </v-card-actions>
                        </v-card>
                                ...
                                <v-form v-show="!loadingAccountFields" ref="formAccount">
                                    ...
                                    <v-row>
                                        <v-col>
                                            ...
                                            <v-progress-linear v-show="progressShow" v-model="progressUpload"
                                                class="grey--text" height="20">
                    ...
                    <v-col>
                        <v-card>
                                ...
                                <v-form v-show="!loadingInscribeFields" ref="formInscribe">
                                    <v-container>
                                        <v-row>
                                            ...
                                            <v-col cols="12" md="6">
                                                <v-text-field label="Telefone" v-model="inscribePhone"
                                                    v-mask="maskTel(inscribePhone)"></v-text-field>
                                            </v-col>
                                        </v-row>
                                        <v-row>
                                            <v-col cols="12" md="4" lg="2">
                                                <v-text-field label="CEP" v-model="inscribeAddress.zipcode"
                                                    v-mask="maskCep" @blur="getCEP('inscribeAddress')"></v-text-field>
                                            </v-col>
                                        ...
                                        <v-row>
                                            <v-col cols="12" md="6">
                                                <v-select v-model="inscribeService.idservice" label="Serviço"
                                                    :items="services" item-text="name" item-value="idservice" required>
                                                </v-select>
                                            </v-col>
                                            <v-col cols="12" md="6">
                                                <v-select v-model="inscribeFormation.idformation" label="Formação"
                                                    :items="formation" item-text="name" item-value="idformation"
                                                    required>
                                                </v-select>
                                            </v-col>
                                        </v-row>
                                        ...
                                        <v-row>
                                            <v-col cols="12" md="4" lg="2">
                                                <v-text-field label="CEP" v-model="eventAddress.zipcode"
                                                    v-mask="maskCep" @blur="getCEP('eventAddress')"></v-text-field>
                                            </v-col>
                                            <v-col cols="12" md="8" lg="6">
                            ...
                            <v-card-text v-show="showTabInscribe == 'engaged'">
                                ...
                                <v-form v-show="!loadingEngagedFields" ref="formEngaged">
                                    <v-container>
                                        ...
                                        <v-row>
                                            ...
                                            <v-col v-show="crud == 'c'" cols="12" md="6">
                                                <v-checkbox v-model="engagedBrideAccountable"
                                                    label="Responsável pelo contrato" @click="selectAccountableBride()">
                                                </v-checkbox>
                                            </v-col>
                                        </v-row>
                                        <v-row>
                                            <v-col cols="12" lg="4">
                                                <v-text-field prepend-inner-icon="mdi-human-female" label="Nome"
                                                    v-model="engagedBrideName" :rules="engagedBrideNameRules" required>
                                                </v-text-field>
                                            </v-col>
                                            <v-col cols="12" md="6" lg="4">
                                                <v-text-field prepend-inner-icon="mdi-human-female"
                                                    v-mask="maskTel(engagedBridePhone)" label="Telefone"
                                                    v-model="engagedBridePhone" :rules="engagedBridePhoneRules"
                                                    required>
                                                </v-text-field>
                                            </v-col>
                                            <v-col cols="12" md="6" lg="4">
                                                <v-text-field prepend-inner-icon="mdi-human-female"
                                                    v-mask="maskTel(engagedBrideMobile)" label="Celular"
                                                    v-model="engagedBrideMobile" :rules="engagedBrideMobileRules"
                                                    required>
                                                </v-text-field>
                                            </v-col>
                                        </v-row>
                                        <v-row>
                                            ...
                                            <v-col cols="12" md="6" lg="2">
                                                <v-text-field prepend-inner-icon="mdi-human-female" label="Número"
                                                    v-model="engagedBrideAddress.number"
                                                    :rules="engagedBrideAddressRules" required></v-text-field>
                                            </v-col>
                                            <v-col cols="12" md="6" lg="2">
                                                <v-text-field prepend-inner-icon="mdi-human-female" label="Complemento"
                                        ...
                                        <v-row>
                                            ...
                                            <v-col cols="12" md="6" lg="3">
                                                <v-text-field prepend-inner-icon="mdi-human-female"
                                                    ...
                                                    v-model="engagedBrideAddress.city" :rules="engagedBrideAddressRules"
                                        ...
                                        <v-row>
                                            ...
                                            <v-col v-show="crud == 'c'" cols="12" md="6">
                                                <v-checkbox v-model="engagedGroomAccountable"
                                                    label="Responsável pelo contrato" @click="selectAccountableGroom()">
                                                </v-checkbox>
                                            </v-col>
                                        </v-row>
                                        <v-row>
                                            <v-col cols="12" lg="4">
                                                <v-text-field prepend-inner-icon="mdi-human-male" label="Nome"
                                                    v-model="engagedGroomName" :rules="engagedGroomNameRules" required>
                                                </v-text-field>
                                            </v-col>
                                            <v-col cols="12" md="6" lg="4">
                                                <v-text-field prepend-inner-icon="mdi-human-male" label="Telefone"
                                                    v-model="engagedGroomPhone" :rules="engagedGroomPhoneRules"
                                                    required>
                                                </v-text-field>
                                            </v-col>
                                            <v-col cols="12" md="6" lg="4">
                                                <v-text-field prepend-inner-icon="mdi-human-male" label="Celular"
                                                    v-model="engagedGroomMobile" :rules="engagedGroomMobileRules"
                                                    required>
                                                </v-text-field>
                                            </v-col>
                                        </v-row>
                                        <v-row>
                                            ...
                                            <v-col cols="12" md="6" lg="2">
                                                <v-text-field prepend-inner-icon="mdi-human-male" label="Complemento"
                                        ...
                                        <v-row>
                                            ...
                                            <v-col cols="12" md="6" lg="3">
                                                <v-text-field prepend-inner-icon="mdi-human-male"
                                                    :loading="inputLoading" label="Cidade"
                                                    v-model="engagedGroomAddress.city" :rules="engagedGroomAddressRules"
                                                    required></v-text-field>
                                            </v-col>
                                            <v-col cols="12" md="6" lg="3">
                                                <v-text-field prepend-inner-icon="mdi-human-male"
                                    ...
                                    <v-row>
                                        <v-col>
                                            ...
                                            <v-btn text color="teal" dark><v-icon>mdi-plus-circle</v-icon> Cadastrar</v-btn>
                                        </v-col>
                                    </v-row>
                                </v-container>
                                </v-form>
                                <v-dialog v-model="engagedBrideUploadPhoto" transition="dialog-bottom-transition"
                                    ...
                                    <v-card>
                                        ...
                                        <v-card-text>
                                            <v-file-input v-model="currentFile" label="Foto" chips
                                                @change="readEngagedPhoto(currentFile, 'engagedBridePhoto')">
                                            </v-file-input>
                                            <v-progress-linear v-show="progressShow" v-model="progressUpload"
                                                class="grey--text" height="20">
                                                {{progressUpload}} %</v-progress-linear>
                                ...
                                <v-dialog v-model="engagedGroomUploadPhoto" transition="dialog-bottom-transition"
                                    max-width="600" persistent>
                                    <v-card>
                                        <v-toolbar color="teal" dark>
                                        ...
                                        <v-card-text>
                                            <v-file-input v-model="currentFile" label="Foto" chips
                                                @change="readEngagedPhoto(currentFile, 'engagedGroomPhoto')">
                                            </v-file-input>
                                            <v-progress-linear v-show="progressShow" v-model="progressUpload"
                                                class="grey--text" height="20">
                                                {{progressUpload}} %</v-progress-linear>
                                ...
                                <v-form v-show="!loadingCommitteFields" ref="formGraduationCommitte">
                                    ...
                                    <v-row>
                                        <v-col>
                                            ...
                                            <v-text-field v-model="graduationCommitteName" label="Membro da comissão"
                                                :rules="graduationCommitteNameRules" required>
                                            </v-text-field>
                                            <v-btn color="teal" class="white--text" depressed
                                    ...
                                    <v-row>
                                        <v-col>
                                            <v-chip v-for="(member, i) in graduationCommitteMember" :key="i"
                                                class="ma-1" close @click:close="removeMemberGraduationCommitte(i, 1)">
                                                {{member}}</v-chip>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                    ...
                                    <v-row>
                                        <v-col>
                                            <v-form ref="formAddRepertoryItem">
                                                ...
                                                <v-select v-show="!loadingSelectFields" v-model="repertoryMoments"
                                                    label="Momento" :items="moments" item-text="name"
                                                    item-value="idmoments" @change="getMusic(repertoryMoments)">
                                                </v-select>
                                                <v-select v-show="!loadingSelectFields" v-model="repertoryMusic"
                                                    label="Música" :items="music" item-text="name" item-value="idmusic"
                                                    return-object></v-select>
                                                <p v-show="repertoryMusic">Ouvir {{repertoryMusic.name}}</p>
                                                <audio v-show="repertoryMusic" :src="repertoryMusic.url"
                                                    controls="controls"></audio>
                                                <div v-show="repertoryMusic" class="small">{{repertoryMusic.url}}</div>
                                                <v-btn v-show="!loadingSelectFields" depressed
                                                    class="amber darken-3 my-3" dark @click="addRepertoryItem()">
                                    ...
                                    <v-row>
                                        <v-col>
                                            <v-card>
                                                ...
                                                <v-card-text>
                                                    <v-skeleton-loader v-if="loadingListRepertory"
                                                        type="text@2, button"></v-skeleton-loader>
                                                        ...
                                                        <v-list-item v-for="(item, i) in repertory" :key="i">
                                                            ...
                                                            <v-list-item-content>
                                                                ...
                                                                <v-list-item-subtitle>
                                                                    <audio :src="item.music.url" controls="controls"
                                                                        width="200"></audio>
                                                                </v-list-item-subtitle>
                                                                <v-list-item-action>
                                                                    <v-btn v-show="item.music.idmusic != 0" depressed
                                                                        color="amber darken-4" dark
                                                                        @click="delRepertoryItem(item.music.idmusic, item.moments.idmoments)">
                        ...
                        <v-card>
                            ...
                            <v-dialog v-model="dialogSignWithPassword" max-width="400">
                                <v-card>
                                    ...
                                    <v-card-actions>
                                        <v-spacer></v-spacer>
                                        <v-btn class="red darken-3 white--text" depressed
                                            @click="doSignWithPassword(userNow.id)">
                                ...
                                <v-container>
                                    <v-row>
                                        <v-col>
                                            <v-card elevation="0">
                                                <v-card-text>
                                                    <v-alert v-show="hasSignature" border="left" class="justify-right"
                                                        color="red lighten-2" dark>Contrato assinado</v-alert>
                                                    <p class="text-h4 red--text text--darken-3">Resumo do contrato</p>
                                                    <v-skeleton-loader v-if="loadingAgreementFormation"
                                                        type="article@3">
                                                    </v-skeleton-loader>
                                                        ...
                                                        <p class="text-h6">Serviço: {{inscribeService.name}}
                                                            <span v-show="inscribeStatus == 0">
                                                                <v-btn color="red darken-3" text
                                                                    @click="showActive('inscribe')">
                                                                    <v-icon>mdi-pencil</v-icon>alterar serviço
                                                                </v-btn>
                                                            </span>
                                                        </p>
                                                        <p v-show="inscribeServiceTax != null"><b>Taxas:</b></p>
                                                        <p v-show="inscribeServiceTax != null"
                                                            v-for="(tax, i) in inscribeServiceTax">
                                                            <i>{{tax.name}}</i> - R$ {{printMoeda(tax.value)}} <span
                                                    ...
                                                    <div v-show="!loadingAgreementEvent">
                                                        <div v-show="!eventEmpty">
                                                            <p class="text-h6">Dados do evento
                                                                <span v-show="inscribeStatus == 0">
                                                                    <v-btn color="red darken-3" text
                                                                        @click="showActive('inscribe'), activeTabInscribe('events')">
                                                        ...
                                                        <div v-show="eventEmpty">
                                                            ...
                                                            <p>
                                                                <v-btn depressed dark color="red darken-3"
                                                                    @click="showActive('inscribe'), activeTabInscribe('events')">
                                                    ...
                                                    <div v-if="inscribeStatus == 2">
                                                        <v-skeleton-loader v-if="loadingAgreementValues"
                                                            type="article@3">
                                                        </v-skeleton-loader>
                                                ...
                                                <v-card-actions v-show="inscribeStatus == 0">
                                                    <v-checkbox v-show="!eventEmpty" v-model="inscribeAgree"
                                                        color="red darken-3" label="Os dados acima estão corretos">
                                                    </v-checkbox>
                                                    <v-spacer></v-spacer>
                                                    <v-btn v-show="inscribeAgree" depressed large dark
                                                        color="red darken-3" @click="generateContract()">Gerar contrato
                                                    </v-btn>
                                                </v-card-actions>
