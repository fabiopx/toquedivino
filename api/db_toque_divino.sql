...
CREATE TABLE IF NOT EXISTS `toquedivino`.`social_networks` (
  ...
  `engaged_idengaged` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_social_networks_engaged1_idx` (`engaged_idengaged` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `toquedivino`.`engaged_has_signature` (
  ...
  INDEX `fk_engaged_has_signature_signature1_idx` (`signature_idsignature` ASC) VISIBLE,
  INDEX `fk_engaged_has_signature_engaged1_idx` (`engaged_idengaged` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `toquedivino`.`agreements_managers` (
  ...
  INDEX `fk_agreements_managers_signature1_idx` (`signature_idsignature` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `toquedivino`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `toquedivino`.`user` (
  `id` INT NOT NULL AUTO_INCREMENT,
