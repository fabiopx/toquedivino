...
CREATE TABLE IF NOT EXISTS `toquedivino`.`budget` (
  ...
  `discount` FLOAT NULL,
  `addition` FLOAT NULL,
  `dow_payment` FLOAT NULL,
  `dow_payment_date` DATE NULL,
...
-- -----------------------------------------------------
-- Table `toquedivino`.`agreements_managers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `toquedivino`.`agreements_managers` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  `cpf` VARCHAR(45) NOT NULL,
  `office` INT NULL COMMENT '1 = Sócio Proprietário\n2 = Procurador Legal\n3 = Gerente Financeiro',
  `signature_idsignature` INT NOT NULL,
  PRIMARY KEY (`id`, `signature_idsignature`),
  INDEX `fk_agreements_managers_signature1_idx` (`signature_idsignature` ASC),
  UNIQUE INDEX `cpf_UNIQUE` (`cpf` ASC),
  CONSTRAINT `fk_agreements_managers_signature1`
    FOREIGN KEY (`signature_idsignature`)
    REFERENCES `toquedivino`.`signature` (`idsignature`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
