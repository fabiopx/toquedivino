...
CREATE TABLE IF NOT EXISTS `toquedivino`.`engaged` (
  ...
  INDEX `fk_engaged_inscribe1_idx` USING BTREE (`inscribe_idinscribe`) IN,
...
CREATE TABLE IF NOT EXISTS `toquedivino`.`formation_has_instrument` (
  ...
  INDEX `fk_formation_has_instrument_instrument1_idx` (`instrument_idinstrument` ASC) IN,
  INDEX `fk_formation_has_instrument_formation1_idx` (`formation_idformation` ASC) IN,
...
CREATE TABLE IF NOT EXISTS `toquedivino`.`service_has_tax` (
  ...
  INDEX `fk_service_has_tax_tax1_idx` (`tax_idtax` ASC) IN,
  INDEX `fk_service_has_tax_service1_idx` (`service_idservice` ASC) IN,
...
CREATE TABLE IF NOT EXISTS `toquedivino`.`composition` (
  ...
  INDEX `fk_composition_service1_idx` (`service_idservice` ASC) IN,
  INDEX `fk_composition_formation1_idx` (`formation_idformation` ASC) IN,
  INDEX `fk_composition_inscribe1_idx` (`inscribe_idinscribe` ASC) IN,
...
CREATE TABLE IF NOT EXISTS `toquedivino`.`composition_has_instrument` (
  ...
  INDEX `fk_composition_has_instrument_instrument1_idx` (`instrument_idinstrument` ASC) IN,
  INDEX `fk_composition_has_instrument_composition1_idx` (`composition_idcomposition` ASC) IN,
...
CREATE TABLE IF NOT EXISTS `toquedivino`.`variant_tax` (
  ...
  INDEX `fk_variant_tax_inscribe1_idx` (`inscribe_idinscribe` ASC) IN,
...
CREATE TABLE IF NOT EXISTS `toquedivino`.`signature` (
  ...
  INDEX `fk_signature_account1_idx` (`account_idaccount` ASC) IN,
...
CREATE TABLE IF NOT EXISTS `toquedivino`.`budget` (
  ...
  `status` INT NOT NULL DEFAULT 0 COMMENT '0 = iniciado\n1 = validado\n2 = finalizado\n3 = expirado\n4 = cancelado',
  `inscribe_idinscribe` INT NOT NULL,
  PRIMARY KEY (`idbudget`),
  INDEX `fk_budget_inscribe1_idx` (`inscribe_idinscribe` ASC) ,
...
-- -----------------------------------------------------
-- Table `toquedivino`.`social_networks`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `toquedivino`.`social_networks` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(200) NULL,
  `engaged` INT NULL COMMENT '1=groom\n2=bride\n3=both',
  `icon` VARCHAR(100) NULL,
  `link` VARCHAR(200) NULL,
  `engaged_idengaged` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_social_networks_engaged1_idx` (`engaged_idengaged` ASC) ,
  CONSTRAINT `fk_social_networks_engaged1`
    FOREIGN KEY (`engaged_idengaged`)
    REFERENCES `toquedivino`.`engaged` (`idengaged`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `toquedivino`.`engaged_has_signature`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `toquedivino`.`engaged_has_signature` (
  `engaged_idengaged` INT NOT NULL,
  `signature_idsignature` INT NOT NULL,
  PRIMARY KEY (`engaged_idengaged`, `signature_idsignature`),
  INDEX `fk_engaged_has_signature_signature1_idx` (`signature_idsignature` ASC) ,
  INDEX `fk_engaged_has_signature_engaged1_idx` (`engaged_idengaged` ASC) ,
  CONSTRAINT `fk_engaged_has_signature_engaged1`
    FOREIGN KEY (`engaged_idengaged`)
    REFERENCES `toquedivino`.`engaged` (`idengaged`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_engaged_has_signature_signature1`
    FOREIGN KEY (`signature_idsignature`)
    REFERENCES `toquedivino`.`signature` (`idsignature`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
