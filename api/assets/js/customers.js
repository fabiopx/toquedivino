	...
	methods: {
		...
		calculateContractValueTotal: function () {
			totalValue =
				...
				parseFloat(this.contractDiscount) +
				parseFloat(this.contractAddition);
		...
		getServices: function () {
			...
			axios.get(this.urlApi + "getServices").then((response) => {
		...
		getFormations: function () {
			...
			axios.get(this.urlApi + "getFormation").then((response) => {
		...
		getInscribe: function () {
			...
			axios
				.get(this.urlApi + "getInscribeCustomers/" + this.userNow.id)
				.then((response) => {
		...
		getAgreement: function () {
			...
			axios
				.get(this.urlApi + "getAgreement/" + this.inscribeID)
				.then((response) => {
		...
		getEvent: function () {
			...
			axios
				.get(this.urlApi + "getEventCustomers/" + this.inscribeID)
				.then((response) => {
					const resp = response.data;
					if (resp) {
		...
		getEngaged: function () {
			...
			axios
				.get(this.urlApi + "getEngagedCustomers/" + this.inscribeID)
				.then((response) => {
					const resp = response.data;
					if (resp) {
						this.crud = "u";
		...
		getCommitte: function () {
			...
			axios
				.get(this.urlApi + "getCommitteCustomers/" + this.inscribeID)
				.then((response) => {
					const resp = response.data;
					if (resp) {
						this.crud = "u";
		...
		getRepertory: function () {
			...
			axios
				.get(this.urlApi + "getRepertoryCustomers/" + this.inscribeID)
				.then((response) => {
					const resp = response.data;
					if (resp) {
		...
		getRepertoryID: function () {
			axios
				.get(this.urlApi + "getRepertoryCustomersID/" + this.inscribeID)
				.then((response) => {
		...
		getMoments: function () {
			...
			axios.get(this.urlApi + "getMomentsCustomers").then((response) => {
		...
		getMusic: function (id) {
			this.loadingSelectFields = true;
			axios.get(this.urlApi + "getMusicCustomers/" + id).then((response) => {
		...
		getTax: function () {
			axios
				.get(this.urlApi + "getTaxByService/" + this.inscribeID)
				.then((response) => {
		...
		verifySignature: function () {
			axios
				.get(this.urlApi + "verifySignCustomers/" + this.userNow.id)
				.then((response) => {
		...
		saveAccount: function () {
			...
			data.append(
				"photo",
				this.currentFile
					? "assets/uploads/" + this.currentFile.name
					: this.accountPhoto
			);
		...
		delRepertoryItem: function (music, moments) {
			axios
				.get(this.urlApi + "deleteRepertoryItem/" + music + "/" + moments)
				.then((response) => {
					Swal.fire(response.data.msg, "", response.data.icon);
					this.getRepertory();
				});
